...
<head>
    <meta charset="utf-8">
    <title>M.O Styling Fashion</title>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="{{ route('userHome') }}" class="navbar-brand">
                    <h1 class="text-primary display-6">M.O Styling</h1>
                </a>
                    ...
                    <div class="d-flex m-1 me-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown">
                                <img src="{{ asset(Auth::user()->profile != null ? 'profile/' . Auth::user()->profile : 'default/profilePic.jpg') }}"
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">M.O Styling</h1>
